...
RUN echo "Building with arguments:\n" \
    ...
    && echo "VITE_VIETTEL_MONEY_ENABLED: $VITE_VIETTEL_MONEY_ENABLED" \
    && echo "VITE_ANALYTICS_ENABLED: $VITE_ANALYTICS_ENABLED" \
    && echo "VITE_PUBLIC_API_ENABLED: $VITE_PUBLIC_API_ENABLED" \
    && echo "VITE_QR_SCANNING_ENABLED: $VITE_QR_SCANNING_ENABLED" \
    && echo "VITE_GUEST_ORDERING_ENABLED: $VITE_GUEST_ORDERING_ENABLED" \
    && echo "VITE_PWA_ENABLED: $VITE_PWA_ENABLED" \
    && echo "VITE_ZALOPAY_ENABLED: $VITE_ZALOPAY_ENABLED" \
    && echo "VITE_OFFLINE_MODE: $VITE_OFFLINE_MODE" \
    && echo "VITE_VNPAY_ENABLED: $VITE_VNPAY_ENABLED"
